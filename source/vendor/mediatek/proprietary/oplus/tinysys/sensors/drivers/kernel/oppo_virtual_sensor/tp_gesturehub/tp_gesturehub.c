...
** VENDOR_EDIT
** File: - tp_gesturehub.h
** Description: Source file for tpgesture sensor linux driver.
** Version: 1.0
** Date : 2020/03/31
**
** --------------------------- Revision History: ---------------------
...
static int tp_gesture_data_report(struct data_unit_t *input_event)
{
    ...
    event.word[0] = input_event->oppo_data_t.tp_gesture_data_t.value;
    event.word[1] = input_event->oppo_data_t.tp_gesture_data_t.report_count;
...
static int tp_gesture_recv_data(struct data_unit_t *event, void *reserved)
{
    ...
    TP_GESTURE_LOG("tp_gesture recv data, flush_action = %d, value = %d, report_count = %d, timestamp = %lld\n",
        event->flush_action,
        event->oppo_data_t.tp_gesture_data_t.value,
        event->oppo_data_t.tp_gesture_data_t.report_count,
