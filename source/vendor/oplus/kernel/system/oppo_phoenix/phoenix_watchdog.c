...
static int phx_pet(void)
{
    if(phx_is_long_time())
    {
        //for P90 platform, need more time
        if (is_project(OPPO_19011) || is_project(OPPO_19301) || is_project(OPPO_18073) || is_project(OPPO_18593))
            schedule_timeout_interruptible(phx_hlos_wd_pet_time * 2 * HZ);
        //for 6125R platform, add more time
        /* Add same timeout for 7150R */
        else if (is_project(OPPO_19021) || is_project(OPPO_19022) || is_project(OPPO_19028) || is_project(OPPO_19029) || is_project(OPPO_19340)
                || is_project(OPPO_19341) || is_project(OPPO_19342) || is_project(OPPO_19325) || is_project(OPPO_19326) || is_project(OPPO_19327)
                || is_project(OPPO_19570) || is_project(OPPO_19571) || is_project(OPPO_19572) || is_project(OPPO_19573) || is_project(OPPO_19575)
                || is_project(OPPO_19576) || is_project(OPPO_19577) || is_project(OPPO_19328) || is_project(OPPO_19579) || is_project(OPPO_19171)
                || is_project(OPPO_19175) || is_project(OPPO_19176) || is_project(OPPO_19375) || is_project(OPPO_19376) || is_project(OPPO_19343)
                || is_project(OPPO_19031) || is_project(OPPO_19111) || is_project(OPPO_19331))
